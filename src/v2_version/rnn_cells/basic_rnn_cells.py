...
class BasicLSTMCell(tf.compat.v1.nn.rnn_cell.RNNCell):
    """
    ...
    def trainable_initial_state(self, batch_size):
        ...
        return tf.nn.rnn_cell.LSTMStateTuple(initial_c, initial_h)


class BasicGRUCell(tf.compat.v1.nn.rnn_cell.RNNCell):
    """
