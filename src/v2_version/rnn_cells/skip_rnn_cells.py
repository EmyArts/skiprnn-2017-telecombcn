...
class SkipLSTMCell(tf.compat.v1.nn.rnn_cell.RNNCell):
    """
...
class MultiSkipLSTMCell(tf.compat.v1.nn.rnn_cell.RNNCell):
    """
...
class MultiSkipGRUCell(tf.compat.v1.nn.rnn_cell.RNNCell):
    """
